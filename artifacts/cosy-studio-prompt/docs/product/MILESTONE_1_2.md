...
## Milestone 2 — Blueprint ZIP import
...
## Explicitly not in M1/M2

URL scanner, architecture graph, risk engine, code generation, verified build, Canvas preview, exports, billing.
