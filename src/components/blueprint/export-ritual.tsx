...
export function ExportRitualOverlay({
  ...
  return (
    <div
      className="app-overlay z-[60] flex items-end sm:items-center justify-center p-0 sm:p-4 bg-bg/75 backdrop-blur-sm"
    ...
    >
      ...
      <div
        className={cn(
          "relative z-10 flex h-full w-full max-h-full flex-col overflow-hidden rounded-none border-0 border-border bg-bg-elevated shadow-soft sm:h-auto sm:max-h-[min(90dvh,var(--app-dvh))] sm:max-w-md sm:rounded-2xl sm:border",
          shake && "export-ritual-shake",
        )}
      >
        <div className="flex items-center justify-between gap-3 border-b border-border px-4 py-2 pt-[max(0.5rem,env(safe-area-inset-top))]">
