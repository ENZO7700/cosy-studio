  ...
  return (
    <div className="relative inline-flex">
      <button
        ...
        className={cn(
          "toggle-btn h-11 w-11 flex items-center justify-center rounded-full border transition-all duration-150",
          active
...
export function ScanForm({
  ...
  return (
    <div className={cn("w-full relative", compact ? "" : "panel p-5 sm:p-6")}>
      ...
      <div className="mb-5 grid w-full grid-cols-2 rounded-xl border border-border bg-bg p-1 text-xs font-medium">
        <button
          type="button"
          disabled={isBusy}
          onClick={() => setMode("url")}
          className={cn(
            "flex min-h-11 items-center justify-center gap-1.5 rounded-lg px-3 py-2 transition-colors",
            mode === "url"
          ...
          <div className="neon-inner">
            {mode === "url" ? (
              <Input
                ...
                inputMode="url"
                disabled={isBusy}
                className="h-12 border-0 bg-transparent shadow-none focus-visible:ring-0 mono text-base px-4"
              />
            ) : (
              <div className="space-y-2 p-2">
                <Input
                  ...
                  disabled={isBusy}
                  className="h-11 border-0 bg-transparent shadow-none focus-visible:ring-0 text-base"
                />
                <Textarea
                  ref={htmlAreaRef}
                  ...
                  disabled={isBusy}
                  className="min-h-[140px] border-0 bg-transparent shadow-none focus-visible:ring-0 mono text-base resize-none"
                />
              </div>
            )}
          </div>
      ...
      <div className="mb-2 flex flex-wrap items-center justify-between gap-2 rounded-full border border-border bg-bg px-3 py-1.5">
        <span className="shrink-0 text-xs text-fg-subtle">{t("scan.options")}</span>
