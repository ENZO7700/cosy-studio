/**
 * Blueprint Scanner — dashboard catalog.
 * Hub shows 4 primary cards; the rest live under Advanced.
 */
...
export const TOOL_CATEGORIES: ToolCategoryDef[] = [
  ...
  },
  {
    ...
    labelEn: "Export",
    labelSk: "Export",
    descEn: "JSON, Elementor draft, ZIP, import",
    descSk: "JSON, Elementor draft, ZIP, import",
  },
  {
    id: "ai",
    labelEn: "Architecture Brief",
    labelSk: "Architecture Brief",
    descEn: "Completeness + stack prompts for Cursor",
    descSk: "Completeness + stack prompty pre Cursor",
  },
  {
    id: "history",
...
/** Four hub cards — the product face. */
export const PRIMARY_CARDS: ToolCardDef[] = [
  {
    id: "wp-migrate",
    category: "wordpress",
    icon: "Blocks",
    titleEn: "WP → Cursor brief",
    titleSk: "WP → Cursor brief",
    descEn: "Scan a WordPress / JetEngine site into an Architecture Brief for Cursor.",
    descSk: "Sken WordPress / JetEngine webu do Architecture Brief pre Cursor.",
  ...
  },
  {
    ...
    descEn: "Colors, fonts, typography and CSS variables from the public CSS.",
    descSk: "Farby, fonty, typografia a CSS premenné z verejného CSS.",
  ...
  },
  {
    ...
    titleSk: "Architecture Brief",
    descEn: "Completeness % + copy-ready prompts for Cursor / Claude.",
    descSk: "Completeness % + prompty pripravené na kopírovanie do Cursora / Claude.",
    action: { type: "tab", tab: "brief" },
    tone: "accent",
  },
  {
    id: "diff",
    ...
    titleEn: "Compare snapshots",
    titleSk: "Porovnať snapshoty",
    descEn: "Diff title, hash, tech, links, assets and pages between two scans.",
    descSk: "Porovná title, hash, tech, odkazy, assety a stránky medzi dvoma skenmi.",
...
export const TOOL_CARDS: ToolCardDef[] = [
  ...
  },
  {
    ...
    descEn: "Download images and fonts into ZIP. Copyright is your responsibility.",
    descSk: "Stiahne obrázky a fonty do ZIP. Za autorské práva zodpovedáš ty.",
  ...
  },
  {
    ...
    descEn: "Best-effort Elementor template draft from the public DOM.",
    descSk: "Best-effort Elementor draft z verejného DOM.",
    action: { type: "tab", tab: "elementor" },
    tone: "success",
  },
  {
...
export function homeHrefForAction(action: ToolAction): string {
  if (action.type === "home") {
    ...
    return q ? `/scan?${q}` : "/scan";
  }
  if (action.type === "open") return `/scan?open=${action.panel}`;
  if (action.type === "tab") return `/scan?tab=${action.tab}`;
  return "/scan";
}
