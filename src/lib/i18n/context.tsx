...
export function LanguageSwitcher({ className = "" }: { className?: string }) {
  ...
  return (
    <div
      ...
      className={`inline-grid grid-cols-2 w-[5.25rem] shrink-0 rounded-lg border border-border overflow-hidden text-[11px] font-medium leading-none ${className}`}
    >
      <button
        type="button"
        ...
        className={
          locale === "en"
            ? "h-11 grid place-items-center bg-accent text-accent-fg"
            : "h-11 grid place-items-center text-fg-muted hover:text-fg"
        }
      >
        EN
      </button>
